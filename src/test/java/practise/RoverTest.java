...
public class RoverTest {
    ...
    public void expect_Rovers_End_Position(){
        ...
        String end_coordinates_for_first_rover = start_coordinates_for_first_rover.nextPosition(instructions_for_first_rover);
        String end_coordinates_for_second_rover = start_coordinates_for_first_rover.nextPosition(instructions_for_second_rover);
